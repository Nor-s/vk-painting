...
namespace vkcpp
{
    void Pipeline::init_pipeline()
    {
        ...
        const VkExtent2D &extent = swapchain_->get_ref_properties().extent;
        VkViewport viewport{};
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        ...
        if (vkCreateGraphicsPipelines(*device_, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &handle_) != VK_SUCCESS)
        {
