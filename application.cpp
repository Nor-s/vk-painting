...
{
    auto vertShaderCode = readFile("../shaders/vs_default.spv");
    auto fragShaderCode = readFile("../shaders/fs_default.spv");
...
void App::createTextureImage()
{
    ...
    stbi_uc *pixels = stbi_load("../textures/img.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
